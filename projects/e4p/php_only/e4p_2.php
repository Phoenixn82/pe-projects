...
<form method="POST">
	<div class="form rectangle-room">
		...
		<?php if(isset($_POST['area_submitted'])): ?>
...
<form method="POST">
	<div class="form pizza-party">
		...
		<?php if(isset($_POST['pizza_submitted'])): ?>
...
if ( isset($_POST['paint_submitted']) ) {
	...
	// Check for plural or singular form of "gallons"
	if ($gallons == 1) {
		$paint_result = "You will need to purchase " . $gallons . " gallon of paint to cover " . $paint_area . " square feet.";
	} else {
		$paint_result = "You will need to purchase " . $gallons . " gallons of paint to cover " . $paint_area . " square feet.";
	}
}
?>
...
<section class='form-parent'>
	<form method="POST">
		<div class="form paint-calculator">
			...
			<label>What is the width of the room?</label>
			<input type="number" name="paint-width" value="<?=$paintwidth?>">
			<?php if(isset($_POST['paint_submitted'])): ?>
...
<section class='form-parent'>
	<form method="POST">
		<div class="form self-checkout">
			...
			<?php if (isset($_POST['checkout_submitted'])) { ?>
...
<section class='form-parent'>
	<form method="POST">
		<div class="form currency-convertor">
			...
			<?php if(isset($_POST['currency_submitted'])): ?>
...
<section class='form-parent'>
	<form method="POST">
		<div class="form simple-interest">
			...
			<?php if ($simple_interest_result !== null): ?>
				<p class='output simple_interest_output'><?=$simple_interest_result?></p>
			<?php endif; ?>
			
			<button type='submit' name="simple_interest_submitted">Calculate</button>
		</div>
	</form>
</section>
...
<?php 
	...
	if (isset($_POST['compound_interest_submitted'])) {
		...
		// If the form hasn't been submitted, set the result value to an empty string
...
<section class='form-parent'>
	<form method="POST">
		<div class="form compound-interest">
			...
			<!-- Output the result only if the form has been submitted -->
			<?php if (isset($_POST['compound_interest_submitted'])) : ?>
