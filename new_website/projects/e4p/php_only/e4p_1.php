...
<section class='form-parent'>
	<form method="POST">
		<div class='form simple_math'>
			...
			<?php if (isset($_POST['simple_math_submitted'])): ?>
...
if ( isset($_POST['retirement_submitted']) ) {
	if (isset($_POST['current_age']) && isset($_POST['retirement_age'])) {
		$current_age = $_POST['current_age'];
		$retirement_age = $_POST['retirement_age'];
		if (!empty($current_age) && !empty($retirement_age)) {
			...
			$retirement_output = "Please enter valid values for current age and retirement age.";
		}
	} else {
		$retirement_output = "Please enter valid values for current age and retirement age.";
	}
